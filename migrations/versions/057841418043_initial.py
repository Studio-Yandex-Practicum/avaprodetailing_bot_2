...
Revision ID: 057841418043
Revises: 
Create Date: 2024-04-06 15:54:29.059016
...
def upgrade() -> None:
    ...
    op.create_table('bonus_case',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=120), nullable=False),
    sa.Column('type', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('bonus_time',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('day', sa.Date(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['case_id'], ['bonus_case.id'], ),
    sa.ForeignKeyConstraint(['time_id'], ['bonus_time.id'], ),
    ...
    sa.ForeignKeyConstraint(['batch_id'], ['bonuses_batch.id'], ),
    sa.ForeignKeyConstraint(['case_id'], ['bonus_case.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('car')
    op.drop_table('bonuses_batch')
    op.drop_table('user')
    op.drop_table('payment')
    op.drop_table('bonus_time')
    op.drop_table('bonus_case')
    # ### end Alembic commands ###
